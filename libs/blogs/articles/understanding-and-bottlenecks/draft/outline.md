...
The title remains _Understanding and Bottlenecks_. The revision opens directly
...
that cycle with the same visual system used by the training figure in _Vision and Values_, but keep the mechanics explicitly inference-only: the
