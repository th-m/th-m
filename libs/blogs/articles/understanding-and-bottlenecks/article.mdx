...
import { Card, CardContent, CardHeader, CardTitle, formatDate, Link, LinkPreview, NeuralInferenceFigure, Note, proofPipeline, ProofPipelineFigure, Tooltip, TooltipContent, TooltipProvider, TooltipTrigger, understandingLoop, UnderstandingLoopFigure } from "./article-components"
...
<Section index="01" title="Two Ways Output Outruns Understanding">
          ...
          <P>
            ...
            <ArticleLink slug="truth-and-inference">
              Truth and Inference
            </ArticleLink>{" "}
...
<Section index="02" title="From Output to Shared Understanding">
          ...
          <Callout title="Distillation preserves">
            <ul>
          ...
          <Callout title="Five dimensions of product understanding">
            <table>
              <thead>
                <tr>
                  <th>Dimension</th>
...
<Section
        ...
        >
          ...
          <Callout title="Centralized gate versus evaluative boundaries">
            <table>
              <thead>
                <tr>
                  <th></th>
...
<div className="article-outline__closing">
          ...
          <P>
            ...
            <ArticleLink slug="the-knowledge-factory">
