...
import { Card, CardContent, CardHeader, formatDate, LinkPreview, Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from "./article-components"
...
<Section index="04" title="The argument in one line">
          ...
          <Callout label="Theory-dependent inference">
