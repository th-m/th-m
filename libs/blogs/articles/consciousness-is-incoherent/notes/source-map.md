# Source map from earlier essays
...
The public essay sharpens this from “contradictory definitions” to
**incompatible membership rules**. Theories can share the same target—felt
experience—while disagreeing about which mechanism is sufficient for a system
...
> artificial system demonstrably instantiates X, then that system should count
> as conscious under that theory.

The new essay expresses the same dependency compactly while separating access
from phenomenality:
...
1. definition;
2. discriminating measurement;
3. validated bridge; and
4. causal instantiation.
