...
- `truth-and-inference/notes/pre-mdx-markdown.md`

## Catalog Review

| Article | Consolidation result |
| --- | --- |
| `vision-and-values` | Rebuilt as Markdown-first MDX, combining the fuller authored explanation with all rendered figures, tables, previews, callouts, and tooltips. |
...
| `truth-and-inference` | Promoted the reviewed theological parallels and semantic-composition introduction from the preserved Markdown into the canonical MDX. |
...
| `understanding-and-bottlenecks` | Reviewed with no Markdown-only prose gaps; the MDX already retained the complete authored text and registered interactives. |
