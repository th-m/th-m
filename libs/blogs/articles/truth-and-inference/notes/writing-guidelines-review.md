# Writing-guidelines review: *Truth and Inference*
...
constraints and feedback encoded by domains. *Vision and Values* owns
...
- **The close respects the series architecture.** It explains predictive
  ...
  with people and with *Vision and Values*. **Why: B1; C4, C9.**
