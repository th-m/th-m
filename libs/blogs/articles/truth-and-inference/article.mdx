...
<Lede>
            ...
            <P style={{ fontSize: 14, lineHeight: 1.7, color: "var(--color-foreground-muted)" }}>
              Building on{" "}
              <LinkPreview url="/writing/vision-and-values" asChild>
                <Link to="/writing/$slug" params={{ slug: "vision-and-values" }}>Vision and Values</Link>
              </LinkPreview>
              {", this essay leads into "}
              <LinkPreview url="/writing/understanding-and-bottlenecks" asChild>
                <Link to="/writing/$slug" params={{ slug: "understanding-and-bottlenecks" }}>Understanding and Bottlenecks</Link>
              </LinkPreview>
              {" and "}
...
<Section index="01" title="Truth and Propositional Formulations">
          ...
          <P>
            ...
            <LinkPreview url="/writing/vision-and-values" asChild>
              <Link to="/writing/$slug" params={{ slug: "vision-and-values" }}>
                Vision and Values
              </Link>
            </LinkPreview>
            {": which futures should govern action, who has standing and authority, and how consequences revise the goal cannot be supplied by formalism alone. "}
...
<Section index="02" title="From Context to Coordinates to Probabilities">
          ...
          <P>
            ...
            that shift narrows uncertainty. For a visual walkthrough of the cross-entropy and backpropagation that
            shaped these weights, see{" "}
            <LinkPreview url="/writing/building-an-llm" asChild>
              <Link to="/writing/$slug" params={{ slug: "building-an-llm" }}>
                Building an LLM
              </Link>
            </LinkPreview>
            .
...
<Section index="05" title="Why Code Is So Pattern-Dense">
          ...
          <P>
            ...
            matters. That consequence becomes a case study in Understanding and Bottlenecks.
          </P>
          <P>
