...
`research/`; and introduce `article.md` and an optional `index.tsx` page only
when publication is intentional. Keep public article assets in the sibling
`assets/` directory.
...
`article.md`, its intentional assets, and an intentional `index.tsx` page may
