...
The figure above is a live proposition graph: pick a claim in the explorer to
follow its relationships. You can open the same graph in the right-side tool
drawer.

[Explore the graph →](/relationship-graph)
...
adaptation** of Michael Levin's cognitive light cone: it uses the metaphor as a
diagnostic for how much of the relevant domain a system can observe, interpret,
