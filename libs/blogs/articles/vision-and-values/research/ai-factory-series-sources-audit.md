...
| --- | --- | --- | --- |
| Vision and Values | Yes | Yes | Has nine-item `References` section in both surfaces |
| Truth and Inference | Yes | Yes | Four inline links; no closing section |
| Understanding and Bottlenecks | Yes | Yes | Five inline links; no closing section |
...
- `vision-and-values`: rename and update the existing Markdown and JSX
  lists together.
- `truth-and-inference`, `understanding-and-bottlenecks`,
