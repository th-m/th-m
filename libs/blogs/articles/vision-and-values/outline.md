...
constraints, and prompting practice belong to *Truth and Inference*.
...
1. **Vision and Values** establishes why human stakes, judgment, and
   authority must govern the problem space.
2. **Truth and Inference** explains how language carries constraints,
   when predictive fluency becomes reliable, and when coherence only resembles
   understanding.
3. **Understanding and Bottlenecks** examines how people and organizations
...
- Keep the detailed explanation of entropy, domain language, code constraints,
  and prompting in *Truth and Inference*.
...
This is the handoff to *Truth and Inference*. Some language carries these
