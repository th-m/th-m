# Writing Guidelines Review: *Vision and Values*
...
- *Vision and Values* owns human values, wisdom, lived experience,
  normative authority, problem selection, strategy, and corrigibility.
- *Truth and Inference* owns most of the explanation of tokenization,
...
cross-entropy, architecture, and decoding explanation to *Truth and Inference*.
