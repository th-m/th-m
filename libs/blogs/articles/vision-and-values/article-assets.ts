...
export default defineArticleAssets({
  "goal-tree-figure": { kind: "figure", label: "Goal Tree Figure", tags: ["article-figure", "mdx-component"] },
  "governing-loop-figure": { kind: "figure", label: "Governing Loop Figure", tags: ["article-figure", "mdx-component"] },
  "language-compression-figure": { kind: "figure", label: "Language Compression Figure", tags: ["article-figure", "mdx-component"] },
  "morpheme-to-token-motif": { kind: "figure", label: "Vision to Morpheme Motif", tags: ["article-figure", "ai-factory-series", "mdx-component"] },
  "morpheme-glossary": { kind: "interactive", label: "Language Units Glossary", tags: ["reference", "glossary", "popover"] },
