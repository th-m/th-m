...
<Section index="02" title="What the Previous Articles Establish">
        ...
        <ul>
          ...
          <li>
            <strong><ArticleLink slug="truth-and-inference">Truth and Coherence</ArticleLink>:</strong>{" "}
          ...
          <li>
            ...
            complete learning loops move interpretation, action, and revision into bounded teams without losing
            shared intent or explicit interfaces.
          </li>
        </ul>
