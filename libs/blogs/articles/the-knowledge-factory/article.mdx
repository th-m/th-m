...
<Section index="16" title="12. Ontology Makes It Coherent; Cognition Makes It Learn">
        <P>
          ...
          <ArticleLink slug="the-cognitive-factory">Cognitive Factory</ArticleLink> connects typed observations,
          bounded authority, inspectable agent work, evaluated consequences, and retained learning.
        </P>
        <P>
