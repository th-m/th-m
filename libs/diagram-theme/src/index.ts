...
export function diagramCss(theme: DiagramTheme): string {
  ...
  return `:root, svg {
    ...
    --color-border:${c.rule}; --color-border-strong:${c.boundary}; --color-primary:${c.accent}; --color-error:${c.error};
