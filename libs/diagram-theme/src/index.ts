...
export function diagramStyleGuide(theme: DiagramTheme): string {
  ...
  return `# THOM diagram style guide\n\nGenerated from @th-m/design-theme. Regenerate with diagrams:setup after token changes.\n\n` +
    ...
    `\n## Composition\n\nUse the upstream diagram grammar with THOM's dark canvas, square surfaces, fine rules, and generous space. Gold marks purpose, agency, and selected paths. Information blue marks specific truth evaluations and evidence provenance, not verified status. Truthy is their gray dotted interface (legacy icon key: truth). Use --color-info or data-thom-role=\"info\" for evidence labels and edges. Red marks faults or contradictions; missing connections retain their gold cross. Neutral ink carries structure; shapes and labels preserve meaning without color.\n\n` +
    `Small filled dots identify participants or instances; larger outlined circles identify meaning or concepts, triangles information, diamonds interventions, pentagons artificial agents, and frames bounded systems or artifacts. Text uses grouped solid strokes; blocks encode units. Match the visual weight of peer alternatives; size does not indicate worth or certainty. Leave air around glyphs except at deliberate connection ports.\n\n` +
    `Solid strokes express wholeness, defined identity, or established connections. Dotted strokes express openness, flexibility, possibility, or movement. Arrows add direction; labels name the relationship. Goal's dotted boundary motivates movement. Opportunity, Experiment, Inference, and Implementation use dotted paths; Automation remains solid. Coherence uses solid internal connections, Threshold a solid boundary, and Bottleneck a solid output with dotted flow. Return and revision paths are dotted; system wiring and ownership brackets remain solid. Regular dots express openness, not the irregular red fragmentation of damage. Shared icons own their stroke semantics; do not override them per scene.\n\n` +
    `Reuse canonical icons with <g data-thom-icon="goal" transform="translate(x y) scale(s)"/> (160-unit glyph frame); retain the catalog meaning. Experience is a labeled node, never a Vision alias. Use 14px Inter for concepts and captions, 10px mono for metadata, square nodes, readable relationship labels, and explicit disconnected marks. Mobile scenes need an authored compact reading path with an optional full diagram, not a scaled-down desktop canvas. Use categories only when they encode a labeled distinction. Preserve all supplied text. Embed the supplied fonts.\n` +
