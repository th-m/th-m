...
- **Frontend:** TypeScript, React, React Router, Vite, Tailwind, component systems, stateful product UX
- **Backend:** Node.js, Go, serverless functions, REST, GraphQL, typed service boundaries
- **Data:** PostgreSQL, Supabase, Firebase, schema design, migrations, realtime data flows
- **Platform:** Netlify, Vercel, Docker, CI/CD, generated clients, test automation
- **Product domains:** developer tools, learning platforms, realtime collaboration, automation, AI-assisted workflows

## Best Fit

I am a strong fit for staff or principal software engineering roles where the job is bigger than closing tickets:

- turning unclear product goals into coherent technical direction
- designing systems that support both current delivery and future change
- raising engineering quality through types, tests, review, and better tooling
- moving comfortably across frontend, backend, data, infrastructure, and product conversations

If you are hiring for a builder who can lead technically while still staying close to the code, that is the lane where I do my best work.
