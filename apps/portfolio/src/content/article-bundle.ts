 ...
 * Strategy essays. Positions live in a fixed 960x660 viewBox that the
...
export const articleBundleNodes: BundleNode[] = [
  ...
  { slug: "the-factory-strategy", kind: "branch", x: 610, y: 520, width: 240, height: 120 },
];
...
export const articleBundleEdges: BundleEdge[] = [
  ...
  { from: "the-knowledge-factory", to: "the-factory-strategy" },
];
