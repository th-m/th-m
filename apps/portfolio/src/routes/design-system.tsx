...
export function DesignSystemPage() {
  return (
    <>
      <a className="skip-link" href="#main">Skip to design system</a>
      <header className="site-header">
        ...
        <nav aria-label="Primary navigation">
          ...
          <Link to="/design-system" activeProps={{ "aria-current": "page" }}>System</Link>
          <Link to="/writing">Writing</Link>
        </nav>
      </header>

      <main className="mx-auto w-[calc(100vw-24px)] pb-24 pt-32 text-foreground md:w-[min(1440px,calc(100vw-48px))]" id="main">
        <section className="border-b border-border pb-20 pt-10 md:pb-28">
          <p className="font-mono text-[10px] uppercase tracking-[.2em] text-primary">THOM · System 1.0</p>
          <h1 className="mt-6 max-w-5xl font-display text-6xl font-normal leading-[.86] tracking-[-.055em] text-foreground-strong md:text-8xl lg:text-9xl">Color with a job to do.</h1>
        ...
        <footer className="flex flex-wrap items-end justify-between gap-8 border-t border-border pb-4 pt-16">
