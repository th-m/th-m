...
const beforeRoot = resolve(process.cwd(), ".codex/audits/logo-balance/user-directed-revision/playwright-before");
const revisedRoot = resolve(process.cwd(), "public/brand-audit/current");
const outputPath = resolve(process.cwd(), ".codex/audits/logo-balance/user-directed-revision/paper-user-revision-02.png");
