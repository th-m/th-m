...
Work from the th-m root. Read `tools/diagrams/README.md` for commands and output
contracts. If `.bun-tmp/diagram-tools` is absent, run
`bun run nx run diagrams:setup`; otherwise use the installed pinned sources.
