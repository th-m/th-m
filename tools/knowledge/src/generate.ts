...
function boardHtml(manifest: ProofManifest, report: ProofReport, fonts: EmbeddedFonts): string {
  ...
  @font-face{font-family:Newsreader;src:url(data:font/woff2;base64,${fonts.newsreader}) format("woff2");font-weight:200 800}@font-face{font-family:Plex;src:url(data:font/woff2;base64,${fonts.plexMono}) format("woff2")}*{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;background:#050505;color:#f2e5cf;font-family:Plex,monospace}body:before{content:"";position:fixed;inset:0;pointer-events:none;background:radial-gradient(circle at 20% 0,rgba(214,176,106,.09),transparent 34%)}a{color:#d6b06a;text-decoration:none}nav{position:sticky;top:0;z-index:3;display:flex;gap:22px;padding:18px 4vw;background:rgba(5,5,5,.92);border-bottom:1px solid #30291f;font-size:11px}main{max-width:1800px;margin:auto;padding:70px 4vw 140px}.hero{display:grid;grid-template-columns:1.5fr 1fr;gap:80px;padding-bottom:90px}.eyebrow,.section-title p,.artifact header p{color:#d6b06a;font-size:10px;text-transform:uppercase;letter-spacing:.12em}h1,h2,h3{font-family:Newsreader,serif;font-weight:420;margin:0}h1{font-size:clamp(48px,7vw,104px);line-height:.9;max-width:900px}h2{font-size:48px}h3{font-size:27px}.hero>div>p:not(.eyebrow){max-width:700px;color:#a99b87;line-height:1.7}.criteria{list-style:none;padding:0;margin:0}.criteria li{padding:14px 0;border-bottom:1px solid #30291f;text-transform:capitalize}.criteria span{color:#a99b87;margin-right:18px}section{padding:82px 0;border-top:1px solid #30291f}.section-title{display:flex;justify-content:space-between;gap:40px;align-items:flex-end;margin-bottom:36px}.section-title code{display:block;color:#a99b87;font-size:10px;margin-top:12px}.metrics{display:flex;gap:18px;flex-wrap:wrap;justify-content:flex-end}.metrics span{display:grid;gap:5px;min-width:90px;color:#a99b87;font-size:9px}.metrics strong{color:#f2e5cf;font:32px Newsreader,serif}.grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(min(100%,620px),1fr));gap:28px}.artifact{background:#0c0b09;border:1px solid #30291f;border-radius:18px;overflow:hidden}.artifact header{display:flex;justify-content:space-between;align-items:end;padding:20px 24px;border-bottom:1px solid #30291f}.artifact header span{font-size:9px;color:#a99b87}.artifact img{display:block;width:100%;height:clamp(420px,48vw,760px);object-fit:contain;background:#050505}.artifact footer,.evidence{display:flex;gap:20px;padding:14px 24px;border-top:1px solid #30291f;font-size:10px}.evidence{padding:24px 0;border-top:0}details{margin:0 0 28px;color:#a99b87;font-size:11px}details li{margin:8px 0}@media(max-width:800px){.hero{grid-template-columns:1fr}.section-title{display:block}.metrics{justify-content:flex-start;margin-top:26px}}
